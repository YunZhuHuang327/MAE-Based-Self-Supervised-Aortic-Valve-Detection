...
# YOLO Training Only (skip data preparation)
# Uses MAE pre-trained features from 10000 epochs
# Training: patient 1-30, 41-50 (labeled only)
# Validation: patient 31-40 (ALL images)

echo "=========================================="
echo "YOLO Training for Valve Detection"
echo "With MAE Pre-trained Features (10000 epochs)"
echo "=========================================="

# Configuration
ARGS_YAML="/DATA1/yunzhu/SSL/args.yaml"
MAE_CHECKPOINT="/DATA1/yunzhu/SSL/mae_valve_output-10000_epochs/best_model.pth"
...
echo "  MAE checkpoint: $MAE_CHECKPOINT (10000 epochs)"
...
TEMP_CONFIG="/tmp/args_mae_10k_epochs.yaml"
python -c "
import yaml
...
config['project'] = '/DATA1/yunzhu/SSL/valve_mae_10k_results'
config['batch'] = 16
config['workers'] = 4
...
echo ""
echo "Starting YOLO training with MAE pre-trained features (10000 epochs)..."
echo ""
